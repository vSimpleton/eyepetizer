...
class Item {
  ...
  Item({this.data, this.adIndex = 0, this.id = 0, this.type = ''});
...
class PlayInfo {
  String name = '';
  int width = 0;
  List<PlayInfoUrlList> urlList;
  String type = '';
  String url = '';
  int height = 0;

  PlayInfo(
      {this.name = '', this.width = 0, this.urlList, this.type = '', this.url = '', this.height = 0});
  ...
  PlayInfo.fromJson(Map<String, dynamic> json) {
    ...
    if (json['urlList'] != null) {
      ...
      (json['urlList'] as List).forEach((v) {
        urlList?.add(new PlayInfoUrlList.fromJson(v));
      });
    }
    type = json['type'];
    url = json['url'];
...
class Author {
  ...
  bool expert = false;
  int approvedNotReadyVideoCount = 0;
  String icon = '';
  String link = '';
  String description = '';
  int videoNum = 0;
...
class PlayInfoUrlList {
  int size = 0;
  String name = '';
  String url = '';

  PlayInfoUrlList({this.size = 0, this.name = '', this.url = ''});

  PlayInfoUrlList.fromJson(
...
class DataAuthorShield {
  ...
  DataAuthorShield(
      {this.itemId = 0, this.itemType = '', this.shielded = false});
...
class DataAuthorFollow {
  ...
  DataAuthorFollow(
      {this.itemId = 0, this.itemType = '', this.followed = false});
...
class Header {
  ...
  int id = 0;
  bool ifPgc = false;
  bool ifShowNotificationIcon = false;
  String title = '';
  int uid = 0;
  ...
  Header(
      ...
      this.id = 0,
      this.ifPgc = false,
      this.ifShowNotificationIcon = false,
      this.title = '',
      this.uid = 0});
...
class Consumption {
  ...
  Consumption({this.shareCount = 0, this.replyCount = 0, this.collectionCount = 0});
